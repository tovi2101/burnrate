...
function Settings({ settings, onSettingsChange, profiles, onDelete, onSave }: { settings: AppSettings; onSettingsChange: (value: AppSettings) => void; profiles: Record<ProviderId, string[]>; onDelete: (provider: ProviderId, profile: string) => void; onSave: (provider: ProviderId, profile: string) => void }) {
